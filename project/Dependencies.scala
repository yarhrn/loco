...
object Dependencies {
  ...
  lazy val scalaMock = "org.scalamock" %% "scalamock" % "4.3.0" % Test
  ...
  lazy val fs2Reactive = "co.fs2" %% "fs2-reactive-streams" % "1.0.5"
  ...
  lazy val mongodbReactiveStreams = "org.mongodb" % "mongodb-driver-reactivestreams" % "1.12.0"
